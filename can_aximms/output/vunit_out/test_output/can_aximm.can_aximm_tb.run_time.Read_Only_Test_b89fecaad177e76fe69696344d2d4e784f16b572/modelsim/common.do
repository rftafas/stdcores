...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/modelsim/modelsim.ini -wlf {/home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_Only_Test_b89fecaad177e76fe69696344d2d4e784f16b572/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/can_aximm_tb/run_time=100 -g/can_aximm_tb/runner_cfg={"active python runner : true,enabled_test_cases : Read Only Test,output path : /home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_Only_Test_b89fecaad177e76fe69696344d2d4e784f16b572/,tb path : /home/rftafas/Projects/stdcores/can_aximms/output/,use_color : true"} can_aximm.can_aximm_tb(simulation)   -L vunit_lib -L osvvm -L expert -L can_aximm}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/modelsim/modelsim.ini -wlf {/home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_Only_Test_b89fecaad177e76fe69696344d2d4e784f16b572/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/can_aximm_tb/run_time=100 -g/can_aximm_tb/runner_cfg={"active python runner : true,enabled_test_cases : Read Only Test,output path : /home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_Only_Test_b89fecaad177e76fe69696344d2d4e784f16b572/,tb path : /home/rftafas/Projects/stdcores/can_aximms/output/,use_color : true"} can_aximm.can_aximm_tb(simulation)   -L vunit_lib -L osvvm -L expert -L can_aximm' failed
...
proc is_test_suite_done {} {
    set fd [open "/home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_Only_Test_b89fecaad177e76fe69696344d2d4e784f16b572/vunit_results" "r"]
...
proc vunit_compile {} {
    set cmd_show {/usr/bin/python3 -u can_aximm_run.py --compile can_aximm.can_aximm_tb.run_time.Read Only Test}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {/usr/bin/python3} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['/usr/bin/python3', '-u', 'can_aximm_run.py', '--compile', 'can_aximm.can_aximm_tb.run_time.Read Only Test'], cwd='/home/rftafas/Projects/stdcores/can_aximms/output', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
