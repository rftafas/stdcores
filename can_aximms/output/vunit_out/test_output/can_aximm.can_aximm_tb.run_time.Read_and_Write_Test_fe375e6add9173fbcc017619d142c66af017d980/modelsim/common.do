...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/modelsim/modelsim.ini -wlf {/home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_and_Write_Test_fe375e6add9173fbcc017619d142c66af017d980/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/can_aximm_tb/run_time=100 -g/can_aximm_tb/runner_cfg={"active python runner : true,enabled_test_cases : Read and Write Test,output path : /home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_and_Write_Test_fe375e6add9173fbcc017619d142c66af017d980/,tb path : /home/rftafas/Projects/stdcores/can_aximms/output/,use_color : true"} can_aximm.can_aximm_tb(simulation)   -L vunit_lib -L osvvm -L expert -L can_aximm}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/modelsim/modelsim.ini -wlf {/home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_and_Write_Test_fe375e6add9173fbcc017619d142c66af017d980/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/can_aximm_tb/run_time=100 -g/can_aximm_tb/runner_cfg={"active python runner : true,enabled_test_cases : Read and Write Test,output path : /home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_and_Write_Test_fe375e6add9173fbcc017619d142c66af017d980/,tb path : /home/rftafas/Projects/stdcores/can_aximms/output/,use_color : true"} can_aximm.can_aximm_tb(simulation)   -L vunit_lib -L osvvm -L expert -L can_aximm' failed
...
proc is_test_suite_done {} {
    set fd [open "/home/rftafas/Projects/stdcores/can_aximms/output/vunit_out/test_output/can_aximm.can_aximm_tb.run_time.Read_and_Write_Test_fe375e6add9173fbcc017619d142c66af017d980/vunit_results" "r"]
